    ...
    try {
        db.query(
            ...
            async (err, articles) => {
                ...
                const prompt = `Anda adalah chatbot spesialis kesehatan. 
                Jawab pertanyaan berikut hanya berdasarkan konteks kesehatan yang diberikan. 
                Jika pertanyaan di luar kesehatan atau tidak relevan dengan konteks,
                jawab: "Maaf, saya hanya bisa menjawab pertanyaan tentang kesehatan." Konteks: \n${context}\nPertanyaan: ${message}`;
